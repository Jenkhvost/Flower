...
{
	pinkFlowerEnvironment->Temperature = (Temperatures)(pinkFlowerEnvironment->Temperature);
	switchImagePinkFlower();
...
{
	pinkFlowerEnvironment->DayTime = (TimesOfDay)pinkFlowerEnvironment->DayTime;
	switchImagePinkFlower();
...
System::Void Flower::MyForm::buttonNewFlower_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	pinkFlowerEnvironment->Season = (Seasons)pinkFlowerEnvironment->Season;
...
{	
	...
	progressBar1->Value = pinkFlowerEnvironment->SoilMoisture;
	progressBar4->Value = pinkFlowerEnvironment->Season;
	progressBar5->Value = pinkFlowerEnvironment->DayTime;
}
